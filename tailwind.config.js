  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        ...
        'client-reqs': "linear-gradient(to right, rgba(8, 99, 2, .8), rgba(1, 125, 92, .8)), url('https://images.unsplash.com/photo-1526738549149-8e07eca6c147?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1925&q=80')",
     },
    },
  },
  plugins: [
